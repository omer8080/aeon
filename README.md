...
You need to install [Visual Studio Code](https://code.visualstudio.com/Download) to view the code.

### `Install Node`

You need to download and install [Node v16.18.1](https://nodejs.org/en/blog/release/v16.18.1) to run the application.
